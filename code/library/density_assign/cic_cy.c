...
#define __PYX_HAVE__cic_cy
#define __PYX_HAVE_API__cic_cy
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'cic_cy' */
#define __Pyx_MODULE_NAME "cic_cy"
extern int __pyx_module_is_main_cic_cy;
int __pyx_module_is_main_cic_cy = 0;

/* Implementation of 'cic_cy' */
 ...
 * cimport numpy as np
 * 
 * cdef np.ndarray[np.double_t, ndim=1] fn(int a):             # <<<<<<<<<<<<<<
 *     ar = np.array([a,a,a])
 *     return ar
 */

static PyArrayObject *__pyx_f_6cic_cy_fn(int __pyx_v_a) {
 ...
 */
  ...
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_a); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 5, __pyx_L1_error)
 ...
 */
  ...
  if (!(likely(((__pyx_v_ar) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_ar, __pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_INCREF(__pyx_v_ar);
  __pyx_r = ((PyArrayObject *)__pyx_v_ar);
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("cic_cy.fn", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static int __pyx_pymod_exec_cic_cy(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cic_cy},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcic_cy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcic_cy(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cic_cy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cic_cy(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cic_cy(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cic_cy' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cic_cy(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cic_cy", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cic_cy) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cic_cy")) {
      if (unlikely(PyDict_SetItemString(modules, "cic_cy", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cic_cy", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cic_cy");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
